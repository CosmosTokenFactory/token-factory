...
import (
	...
	tokenappparams "github.com/CosmosTokenFactory/token-factory/app/params"
...
var (
	...
	// Features which are enabled. Blank = All.
	// All options with `tokenfactorytypes.Enable*`
...
// API server.
func (app *TokenApp) RegisterAPIRoutes(apiSvr *api.Server, _ config.APIConfig) {
